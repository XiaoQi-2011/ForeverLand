...
inline Item::item (&getInitItem())[ITEM_NUM]
{
    static Item::item init_item[]{
        ...
        Item::item("淬体丹", "淬炼肉身，提升肉身力量\n攻击力+3", 0, 400, 0, "alchemy", 2),
        Item::item("烈血丹", "大幅增幅力量，强化肌肉与精血爆发力\n攻击力+5", 0, 1200, 0, "alchemy", 3),
        Item::item("龙血丹", "塑肉身筋骨，服用后力量成倍暴涨，近战战力质变\n攻击力+8 伤害加成%+1", 0, 2400, 0, "alchemy", 4),
        Item::item("龙涎丹", "龙族力量加持，肉身力量堪比妖兽，长期服用固化肉身上限\n攻击力+12 伤害加成%+2 暴击比率%+1", 0, 6000, 300, "alchemy", 5),
        Item::item("纯阳焚天丹", "铸就纯阳战体，力量突破法则限制\n攻击力+16 伤害加成%+3 暴击比率%+2", 0, 9000, 360, "alchemy", 6),

        Item::item("厚甲丹", "皮肉增厚，降低物理外伤伤害\n防御力+2", 0, 400, 0, "alchemy", 2),
        Item::item("磐石丹", "经脉皮肉强化，灵气自动形成护体屏障\n防御力+4", 0, 1200, 0, "alchemy", 3),
        Item::item("万法护身丹", "魔气、术法、物理伤害全方位削减\n防御力+7", 0, 2400, 0, "alchemy", 4),
        Item::item("补天道铠丹", "修复肉身受损部位，道基化作防御壁垒\n防御力+11 伤害减免%+1", 0, 6000, 300, "alchemy", 5),
        Item::item("青莲不灭丹", "受到致命伤害可触发一次肉身不灭护盾\n防御力+15 伤害减免%+2", 0, 9000, 360, "alchemy", 6),

        Item::item("续元丹", "加快伤口自愈，小幅提升气血上限\n生命值+5", 0, 400, 0, "alchemy", 2),
        Item::item("长生丹", "大幅提升生命上限，内伤快速修复\n生命值+10", 0, 1200, 0, "alchemy", 3),
        Item::item("延寿丹", "壮大本源精血，提升续航能力，延缓寿元损耗\n生命值+15 吸血概率%+1", 0, 2400, 0, "alchemy", 4),
        Item::item("涅槃灵丹", "重伤快速复原，永久提升生命本源上限\n生命值+20 吸血概率%+2 吸血比率%+1", 0, 6000, 300, "alchemy", 5),
        Item::item("还魂造化丹", "保留残魂复活，生命本源得到造化级增幅\n生命值+25 吸血概率%+3 吸血比率%+2", 0, 9000, 360, "alchemy", 6),

        Item::item("续力丹", "淬炼体质，提高耐力和体力\n体力上限+5", 0, 400, 0, "alchemy", 2),
        Item::item("聚灵丹", "增长灵力总量，提升法术释放威力\n灵力上限+10", 0, 1200, 0, "alchemy", 3),
        Item::item("幽冥幻隐丹", "气息虚化，身形半隐匿，提升闪避概率\n闪避概率%+1", 0, 2400, 0, "alchemy", 4),
